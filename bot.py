...
async def home(client, message):
  buttons = [[
    ...
    [
        ...
        InlineKeyboardButton('Source Code', url='https://github.com/ExploitzBots/Telegraph-Uploader')
    ]]
...
Made With Love By @MadPremium</b>""",
...
async def help(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel', url='http://telegram.me/MadPremium')
    ]]
  reply_markup = InlineKeyboardMarkup(buttons)
  await Tgraph.send_message(
        chat_id=message.chat.id,
